...
from utils.perturbations import random_missing, column_missing
...
for rate in missing_rates:
    X_test_miss = random_missing(X_test, rate)
...
df.to_csv("results/tables/missingness.csv", index=False)
print(df)
